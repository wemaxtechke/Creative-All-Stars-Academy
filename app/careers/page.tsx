      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 space-y-10">
        ...
        {jobs.length === 0 && (
          <div className="text-center py-20 bg-white border border-gray-100 rounded-3xl max-w-xl mx-auto space-y-4">
            ...
            <p className="text-gray-500 text-sm leading-relaxed">Our faculty block is currently full. Stay updated by bookmarking this page or dropping your CV at our Ngata desk.</p>
          </div>
        )}
      </section>
