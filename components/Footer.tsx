        ...
        <div className="lg:col-span-5 lg:pr-8">
          ...
          <div className="mt-6 flex items-center gap-3">
            ...
            <a href={settings.twitter} target="_blank" rel="noopener noreferrer" className={socialButtonClass} aria-label="Twitter">
              <svg className="h-5 w-5 fill-current" viewBox="0 0 24 24"><path d="M24 4.6d-.9.4-1.8.5 1-.6 1.8-1.6-.9.5-2 1-2.8-1.1-.9-2.3-2.1-2.3-3.6 0-2.9 2.4-5.3 5.3-5.3.4 0 .8.1 1.2.2-4.4-.2-8.3-2.3-10.9-5.5-.5.8-.7 1.8-.7 2.9 0 1.8.9 3.4 2.3 4.4-.9 0-1.7-.3-2.4-.7v.1c0 2.5 1.8 4.7 4.2 5.2-.4.1-.9.2-1.4.2-.3 0-.7 0-1-.1.7 2.1 2.6 3.6 4.9 3.7-1.8 1.4-4.1 2.2-6.6 2.2-.4 0-.9 0-1.3-.1 2.3 1.5 5 2.4 7.9 2.4 9.5 0 14.7-7.9 14.7-14.7 0-.2 0-.4 0-.7.9-.7 1.7-1.6 2.4-2.5z"/></svg>
            </a>
